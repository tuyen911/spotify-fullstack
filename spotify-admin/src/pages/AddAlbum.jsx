...
const AddAlbum = () => {
  const [image, setImage] = useState(null); // Set to null initially for better checking
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      formData.append("image", image); // Ensure this matches what backend expects
      formData.append("bgColor", colour); // Use the correct key "bgColor"
